 ...
 * JNI single-header class with wrappers and caching for 'org.theko.sound.backends.AudioBackendException'.
 */
#pragma once
#include <jni.h>
#include <mutex>
...
// Target class: org/theko/sound/backends/AudioBackendException
class Java_org_theko_sound_backends_AudioBackendException {
    private:
        ...
        Java_org_theko_sound_backends_AudioBackendException(JNIEnv* env) {
            ...
            if (!ctor__java_lang_String__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.AudioBackendException(java.lang.String,java.lang.Throwable)'");
                return;
            }
            ctor__java_lang_Throwable = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/Throwable;)V");
            if (!ctor__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.AudioBackendException(java.lang.Throwable)'");
                return;
            }
            ctor__java_lang_String = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/String;)V");
            if (!ctor__java_lang_String) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.AudioBackendException(java.lang.String)'");
                return;
            }
            ctor__ = env->GetMethodID(clazz_local, "<init>", "()V");
            if (!ctor__) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.AudioBackendException()'");
                return;
            }
    ...
    public:
        ~Java_org_theko_sound_backends_AudioBackendException() {
            if (clazz) {
                bool attached = false;
        ...
        static Java_org_theko_sound_backends_AudioBackendException* get(JNIEnv* env) {
            if (!env) return nullptr;
            if (!Java_org_theko_sound_backends_AudioBackendException::jvm) {
                env->GetJavaVM(&Java_org_theko_sound_backends_AudioBackendException::jvm);
            }
            static std::mutex mtx;
            static std::unique_ptr<Java_org_theko_sound_backends_AudioBackendException> instance;
        
            std::lock_guard<std::mutex> lock(mtx);
            if (!instance || !instance->isValid()) {
                instance.reset(new Java_org_theko_sound_backends_AudioBackendException(env));
            }
            return instance.get();
        }
        ...
        inline static jmethodID getctor__java_lang_String__java_lang_Throwable(JNIEnv* env) {
            Java_org_theko_sound_backends_AudioBackendException* self = get(env);
        ...
        // Instance creation method for public org.theko.sound.backends.AudioBackendException(java.lang.String,java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.backends.AudioBackendException(java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.backends.AudioBackendException(java.lang.String)
        ...
        // Instance creation method for public org.theko.sound.backends.AudioBackendException()
