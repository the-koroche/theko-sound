...
class Java_org_theko_sound_backends_DeviceInvalidatedException {
    private:
        ...
        Java_org_theko_sound_backends_DeviceInvalidatedException(JNIEnv* env) {
    ...
    public:
        ~Java_org_theko_sound_backends_DeviceInvalidatedException() {
            if (clazz) {
                bool attached = false;
        ...
        static Java_org_theko_sound_backends_DeviceInvalidatedException* get(JNIEnv* env) {
            if (!env) return nullptr;
            if (!Java_org_theko_sound_backends_DeviceInvalidatedException::jvm) {
                env->GetJavaVM(&Java_org_theko_sound_backends_DeviceInvalidatedException::jvm);
            }
            static std::mutex mtx;
            static std::unique_ptr<Java_org_theko_sound_backends_DeviceInvalidatedException> instance;
        
            std::lock_guard<std::mutex> lock(mtx);
            if (!instance || !instance->isValid()) {
                instance.reset(new Java_org_theko_sound_backends_DeviceInvalidatedException(env));
            }
            return instance.get();
        }
        ...
        inline static jmethodID getctor__java_lang_String(JNIEnv* env) {
            Java_org_theko_sound_backends_DeviceInvalidatedException* self = get(env);
