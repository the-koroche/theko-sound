 ...
 * JNI single-header class with wrappers and caching for 'org.theko.sound.backends.DeviceInactiveException'.
 */
#pragma once
#include <jni.h>
#include <mutex>
...
// Target class: org/theko/sound/backends/DeviceInactiveException
class Java_org_theko_sound_backends_DeviceInactiveException {
    private:
        ...
        Java_org_theko_sound_backends_DeviceInactiveException(JNIEnv* env) {
            ...
            if (!ctor__java_lang_String) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.DeviceInactiveException(java.lang.String)'");
                return;
            }
            ctor__java_lang_Throwable = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/Throwable;)V");
            if (!ctor__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.DeviceInactiveException(java.lang.Throwable)'");
                return;
            }
            ...
            if (!ctor__java_lang_String__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.DeviceInactiveException(java.lang.String,java.lang.Throwable)'");
                return;
            }
    ...
    public:
        ~Java_org_theko_sound_backends_DeviceInactiveException() {
            if (clazz) {
                bool attached = false;
        ...
        static Java_org_theko_sound_backends_DeviceInactiveException* get(JNIEnv* env) {
            if (!env) return nullptr;
            if (!Java_org_theko_sound_backends_DeviceInactiveException::jvm) {
                env->GetJavaVM(&Java_org_theko_sound_backends_DeviceInactiveException::jvm);
            }
            static std::mutex mtx;
            static std::unique_ptr<Java_org_theko_sound_backends_DeviceInactiveException> instance;
        
            std::lock_guard<std::mutex> lock(mtx);
            if (!instance || !instance->isValid()) {
                instance.reset(new Java_org_theko_sound_backends_DeviceInactiveException(env));
            }
            return instance.get();
        }
        ...
        inline static jmethodID getctor__java_lang_String(JNIEnv* env) {
            Java_org_theko_sound_backends_DeviceInactiveException* self = get(env);
        ...
        // Instance creation method for public org.theko.sound.backends.DeviceInactiveException(java.lang.String)
        ...
        // Instance creation method for public org.theko.sound.backends.DeviceInactiveException(java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.backends.DeviceInactiveException(java.lang.String,java.lang.Throwable)
