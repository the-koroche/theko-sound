 ...
 * JNI single-header class with wrappers and caching for 'org.theko.sound.backends.PortNotFoundException'.
 */
#pragma once
#include <jni.h>
#include <mutex>
...
// Target class: org/theko/sound/backends/PortNotFoundException
class ThekoSound_PortNotFoundException {
    private:
        ...
        // public org.theko.sound.backends.PortNotFoundException()
        jmethodID ctor__;
        // public org.theko.sound.backends.PortNotFoundException(java.lang.String)
        jmethodID ctor__java_lang_String;
        // public org.theko.sound.backends.PortNotFoundException(java.lang.Throwable)
        jmethodID ctor__java_lang_Throwable;
        // public org.theko.sound.backends.PortNotFoundException(java.lang.String, java.lang.Throwable)
        ...
        ThekoSound_PortNotFoundException(JNIEnv* env) {
            initialized = false; // Reinitialize
            if (!env) return;
            jclass clazz_local = env->FindClass("org/theko/sound/backends/PortNotFoundException");
            if (!clazz_local) {
                env->ThrowNew(env->FindClass("java/lang/RuntimeException"), "Failed to find class 'org/theko/sound/backends/PortNotFoundException'");
                return;
            }
            ...
            if (!ctor__) {
                ...
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.PortNotFoundException()'");
                return;
            }
            ctor__java_lang_String = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/String;)V");
            if (!ctor__java_lang_String) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.PortNotFoundException(java.lang.String)'");
                return;
            }
            ctor__java_lang_Throwable = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/Throwable;)V");
            if (!ctor__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.PortNotFoundException(java.lang.Throwable)'");
                return;
            }
            ...
            if (!ctor__java_lang_String__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.backends.PortNotFoundException(java.lang.String,java.lang.Throwable)'");
                return;
            }
    ...
    public:
        ~ThekoSound_PortNotFoundException() {
            if (clazz) {
                bool attached = false;
        ...
        static ThekoSound_PortNotFoundException* get(JNIEnv* env) {
            if (!env) return nullptr;
            static std::mutex mtx;
            static std::unique_ptr<ThekoSound_PortNotFoundException> instance;
        
            std::lock_guard<std::mutex> lock(mtx);
            if (!ThekoSound_PortNotFoundException::jvm) {
                env->GetJavaVM(&ThekoSound_PortNotFoundException::jvm);
            }
            if (!instance || !instance->isValid()) {
                instance.reset(new ThekoSound_PortNotFoundException(env));
            }
            return instance.get();
        }
        ...
        inline static jmethodID getctor__(JNIEnv* env) {
            ThekoSound_PortNotFoundException* self = get(env);
        ...
        // Instance creation method for public org.theko.sound.backends.PortNotFoundException()
        ...
        // Instance creation method for public org.theko.sound.backends.PortNotFoundException(java.lang.String)
        ...
        // Instance creation method for public org.theko.sound.backends.PortNotFoundException(java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.backends.PortNotFoundException(java.lang.String,java.lang.Throwable)
