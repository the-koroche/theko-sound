 ...
 * JNI single-header class with wrappers and caching for 'org.theko.sound.UnsupportedAudioFormatException'.
 */
#pragma once
#include <jni.h>
#include <mutex>
...
// Target class: org/theko/sound/UnsupportedAudioFormatException
class Java_org_theko_sound_UnsupportedAudioFormatException {
    private:
        ...
        jclass clazz;
        jmethodID ctor__java_lang_String__java_lang_Throwable; // public org.theko.sound.UnsupportedAudioFormatException(java.lang.String,java.lang.Throwable)
        jmethodID ctor__java_lang_Throwable; // public org.theko.sound.UnsupportedAudioFormatException(java.lang.Throwable)
        jmethodID ctor__java_lang_String; // public org.theko.sound.UnsupportedAudioFormatException(java.lang.String)
        jmethodID ctor__; // public org.theko.sound.UnsupportedAudioFormatException()
        ...
        Java_org_theko_sound_UnsupportedAudioFormatException(JNIEnv* env) {
            initialized = false; // Reinitialize
            if (!env) return;
            jclass clazz_local = env->FindClass("org/theko/sound/UnsupportedAudioFormatException");
            if (!clazz_local) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to find class 'org.theko.sound.UnsupportedAudioFormatException'");
                return;
            }
            ...
            if (!ctor__java_lang_String__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.UnsupportedAudioFormatException(java.lang.String,java.lang.Throwable)'");
                return;
            }
            ctor__java_lang_Throwable = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/Throwable;)V");
            if (!ctor__java_lang_Throwable) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.UnsupportedAudioFormatException(java.lang.Throwable)'");
                return;
            }
            ctor__java_lang_String = env->GetMethodID(clazz_local, "<init>", "(Ljava/lang/String;)V");
            if (!ctor__java_lang_String) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.UnsupportedAudioFormatException(java.lang.String)'");
                return;
            }
            ctor__ = env->GetMethodID(clazz_local, "<init>", "()V");
            if (!ctor__) {
                if (clazz_local) env->DeleteLocalRef(clazz_local);
                env->ThrowNew(env->FindClass("java/lang/NullPointerException"), "Failed to get constructor 'public org.theko.sound.UnsupportedAudioFormatException()'");
                return;
            }
    ...
    public:
        ~Java_org_theko_sound_UnsupportedAudioFormatException() {
            if (clazz) {
                bool attached = false;
        ...
        static Java_org_theko_sound_UnsupportedAudioFormatException* get(JNIEnv* env) {
            if (!env) return nullptr;
            if (!Java_org_theko_sound_UnsupportedAudioFormatException::jvm) {
                env->GetJavaVM(&Java_org_theko_sound_UnsupportedAudioFormatException::jvm);
            }
            static std::mutex mtx;
            static std::unique_ptr<Java_org_theko_sound_UnsupportedAudioFormatException> instance;
        
            std::lock_guard<std::mutex> lock(mtx);
            if (!instance || !instance->isValid()) {
                instance.reset(new Java_org_theko_sound_UnsupportedAudioFormatException(env));
            }
            return instance.get();
        }
        ...
        inline static jmethodID getctor__java_lang_String__java_lang_Throwable(JNIEnv* env) {
            Java_org_theko_sound_UnsupportedAudioFormatException* self = get(env);
        ...
        // Instance creation method for public org.theko.sound.UnsupportedAudioFormatException(java.lang.String,java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.UnsupportedAudioFormatException(java.lang.Throwable)
        ...
        // Instance creation method for public org.theko.sound.UnsupportedAudioFormatException(java.lang.String)
        ...
        // Instance creation method for public org.theko.sound.UnsupportedAudioFormatException()
