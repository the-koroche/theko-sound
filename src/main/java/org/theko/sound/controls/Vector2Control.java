...
public class Vector2Control extends AudioControl {
    ...
    private final AudioControlListener valueChangeListener = new AudioControlListener() {
        ...
        public void onValueChange(AudioControlEvent event) {
            eventDispatcher.dispatch(AudioControlEventType.VALUE_CHANGE, new AudioControlEvent(Vector2Control.this));
        }
    };
    ...
    public Vector2Control(String name, float xMin, float xMax, float yMin, float yMax) {
        ...
        xControl.addListener(ListenerPriority.CRITICAL, valueChangeListener);
        yControl.addListener(ListenerPriority.CRITICAL, valueChangeListener);
    }
