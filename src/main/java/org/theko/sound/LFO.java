...
public class LFO implements Controllable {
    ...
    protected Waveform waveformType = Waveform.SINE;
    ...
    protected final List<AudioControl> lfoControls = List.of(amount, phase, speed, attack, base);
    ...
    /** Sets the waveform type for this LFO. */
    public void setWaveformType(Waveform waveformType) {
        this.waveformType = Objects.requireNonNull(waveformType);
    }

    /** @return the waveform type control. */
    public Waveform getWaveformType() {
        return waveformType;
    }
    ...
    public float getValue(float time) {
        ...
        float waveformValue = waveformType.generate(phaseValue);
